...
-- CreateEnum
CREATE TYPE "AppointmentStatus" AS ENUM ('PENDING_PAYMENT', 'CONFIRMED', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'SUCCESS', 'FAILED');

-- CreateEnum
CREATE TYPE "PaymentType" AS ENUM ('SUBSCRIPTION', 'EXTRA_MINUTES');
...
CREATE TABLE "DoctorProfile" (
    ...
    "baseDurationMinutes" INTEGER NOT NULL DEFAULT 30,
    "basePriceKobo" INTEGER NOT NULL DEFAULT 0,
    "extra10MinPriceKobo" INTEGER NOT NULL DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Appointment" (
    ...
    "extraBlocks" INTEGER NOT NULL DEFAULT 0,
